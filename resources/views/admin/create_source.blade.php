                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Create a new Source</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <h5 class="card-header">Create a new Source</h5>
                                <div class="card-body">
                                    <form method="POST" action="{{ url('sources') }}">
                                        @csrf
                                        <div class="form-group">
                                            <label for="inputText3" class="col-form-label">Name of the Source</label>
                                            <input id="inputText3" type="text" class="form-control {{($errors->first('name') ? "form-error" : "")}}" name="name"value="{{ old('name') }}"/>
                                            {!! $errors->first('name', '<p class="text-danger">:message</p>') !!}

                                        </div>
                                        <div class="form-group">
                                            <label for="desc">Brief description of the source</label>
                                            <textarea class="form-control {{($errors->first('description') ? "form-error" : "")}}" id="desc" rows="3" name="description" >{{ old('description') }}</textarea>
